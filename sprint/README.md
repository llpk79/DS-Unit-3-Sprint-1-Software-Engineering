...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  when others do the same for your code?
   ...
   I wasn't able to do this as no one responded to my requests to do so, and it was
   never orchestrated for the class, but if it ever did happen I would pay attention 
   to code correctness (does it do the thing it purports to do) and readability.
   
- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
  
   Containers would help by providing everything a program needs to run in one neat,
   well, container. The environment for the program is isolated from any other programs
   that may affect it.
